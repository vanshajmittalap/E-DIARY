    ...
    return (
        <>
                    ...
                    <div className="modal-content" style={{ backgroundColor: (props.mode==='dark' || props.mode==='primary' || props.mode==='success')?'white':'black'}}>
                        ...
                        <div className="modal-body">
                            <form className="my-3">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="tag" className="form-label" style={myStyle2}>Tag</label>
            ...
            <div className="row my-3">
                <h1 style={{color: (props.mode==='dark' || props.mode==='primary' || props.mode==='success')?'white':'#000066', fontFamily:'fantasy'}}>Your Notes</h1>
